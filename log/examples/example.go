...
func main() {
	...
	// V level使用
	log.V(int(log.InfoLevel)).Info("This is a V level message")
	log.V(int(log.ErrorLevel)).Infow("This is a V level message with fields", "X-Request-ID", "7a7b9f24-4cae-4b2a-9464-69088b45b904")
}
